...
if __name__ == "__main__":
    ...
    # for i in range(10):
        if i == 0:
            output = read_point_cloud("./output/" + idx[i])
            ...
            use_color = [np.linalg.norm(diff_color[l]) < 0.3 for l in range(len(diff_color))]
            ...
            transpose_iter = np.mean(target_xyz-source_xyz, axis=0)
            ...
            displacedSourcePoints = np.add(sourcePoints, transpose)
