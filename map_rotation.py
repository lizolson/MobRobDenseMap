...
if __name__ == "__main__":
    ...
    reading_range = np.add(range(80), 50)
    ...
    for i in reading_range:
        ...
        # if i == 0:
            ...
            if len(source_xyz) > 10:
                ...
                angles = np.multiply(np.subtract(range(20), 10), np.pi/360)
                m = 0
                ...
                for theta in angles:
                    ...
                    # back_target = np.add(target_xyz,-transpose_iter)
                    # target_xz = back_target.transpose()[[0, 2], :]
            ...
            displacedSourcePoints = np.matmul(rotation_best, sourcePoints.transpose())
            ...
            write_point_cloud('finalOutput/' + idx[i], stepout)
    ...
    write_point_cloud('finalOutput/testCloud.ply', output)
